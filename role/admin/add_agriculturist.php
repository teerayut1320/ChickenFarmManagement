                                        ...
                                        <form class="user" action="checkadd_agc.php" method="post">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-3 mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="name" style="border-radius: 3rem;">
                                                </div>
                                                <div class="col-md-2 mb-2">
                                                    <label for="" style="font-size: 1.125rem;">เบอร์โทรศัพท์</label>
                                                    <input type="text" class="form-control" name="phone" style="border-radius: 3rem;">
                                                </div>
                                                <div class="col-md-3 mb-2">
                                                    <label for="" style="font-size: 1.125rem;">ชื่อฟาร์ม</label>
                                                    <input type="text" class="form-control" name="fname" style="border-radius: 3rem;">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"  name="user" style="border-radius: 3rem;">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="" style="font-size: 1.125rem;">รหัสผ่าน</label>
                                                    <input type="text" class="form-control"  name="password" style="border-radius: 3rem;">
                                                </div>
                                            </div>
                                            <div class="row">
